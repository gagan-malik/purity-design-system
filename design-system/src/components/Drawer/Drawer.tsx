...
export const Drawer = ({ open, setOpen, side = "right", children, style }: { style?: React.CSSProperties, children: React.JSX.Element, open: boolean, setOpen: React.Dispatch<React.SetStateAction<boolean>>, side: 'right' | 'left' | 'top' | 'bottom' }) => {
    return (
        <div
            id={`dialog-${side}`}
                ...
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    >
                        ...
                        >
                            <div
                                className={clsx(
                                    "flex flex-col h-full bg-gray-50 p-5 shadow-xl rounded-lg"
                                )}
                            >
                                {children}
                            </div>
