    ...
    extend: {
      ...
      colors: {
        ...
        utility: {
          ...
          grayBlue: {
            50: "var(--utility-gray-blue-50)",
            100: "var(--utility-gray-blue-100)",
            200: "var(--utility-gray-blue-200)",
            300: "var(--utility-gray-blue-300)",
            400: "var(--utility-gray-blue-400)",
            500: "var(--utility-gray-blue-500)",
            600: "var(--utility-gray-blue-600)",
            700: "var(--utility-gray-blue-700)",
          },
          blueLight: {
            50: "var(--utility-blue-light-50)",
            100: "var(--utility-blue-light-100)",
            200: "var(--utility-blue-light-200)",
            300: "var(--utility-blue-light-300)",
            400: "var(--utility-blue-light-400)",
            500: "var(--utility-blue-light-500)",
            600: "var(--utility-blue-light-600)",
            700: "var(--utility-blue-light-700)",
          },
          blue: {
            50: "var(--utility-blue-50)",
            100: "var(--utility-blue-100)",
            200: "var(--utility-blue-200)",
            300: "var(--utility-blue-300)",
            400: "var(--utility-blue-400)",
            500: "var(--utility-blue-500)",
            600: "var(--utility-blue-600)",
            700: "var(--utility-blue-700)",
          },
          blueDark: {
            50: "var(--utility-blue-dark-50)",
            100: "var(--utility-blue-dark-100)",
            200: "var(--utility-blue-dark-200)",
            300: "var(--utility-blue-dark-300)",
            400: "var(--utility-blue-dark-400)",
            500: "var(--utility-blue-dark-500)",
            600: "var(--utility-blue-dark-600)",
            700: "var(--utility-blue-dark-700)",
          },
          indigo: {
            50: "var(--utility-indigo-50)",
            100: "var(--utility-indigo-100)",
            200: "var(--utility-indigo-200)",
            300: "var(--utility-indigo-300)",
            400: "var(--utility-indigo-400)",
            500: "var(--utility-indigo-500)",
            600: "var(--utility-indigo-600)",
            700: "var(--utility-indigo-700)",
          },
          purple: {
            50: "var(--utility-purple-50)",
            100: "var(--utility-purple-100)",
            200: "var(--utility-purple-200)",
            300: "var(--utility-purple-300)",
            400: "var(--utility-purple-400)",
            500: "var(--utility-purple-500)",
            600: "var(--utility-purple-600)",
            700: "var(--utility-purple-700)",
          },
          fuchsia: {
            50: "var(--utility-fuchsia-50)",
            100: "var(--utility-fuchsia-100)",
            200: "var(--utility-fuchsia-200)",
            300: "var(--utility-fuchsia-300)",
            400: "var(--utility-fuchsia-400)",
            500: "var(--utility-fuchsia-500)",
            600: "var(--utility-fuchsia-600)",
            700: "var(--utility-fuchsia-700)",
          },
          pink: {
            50: "var(--utility-pink-50)",
            100: "var(--utility-pink-100)",
            200: "var(--utility-pink-200)",
            300: "var(--utility-pink-300)",
            400: "var(--utility-pink-400)",
            500: "var(--utility-pink-500)",
            600: "var(--utility-pink-600)",
            700: "var(--utility-pink-700)",
          },
          orange: {
            50: "var(--utility-orange-50)",
            100: "var(--utility-orange-100)",
            200: "var(--utility-orange-200)",
            300: "var(--utility-orange-300)",
            400: "var(--utility-orange-400)",
            500: "var(--utility-orange-500)",
            600: "var(--utility-orange-600)",
            700: "var(--utility-orange-700)",
          },
        },
        ...
        button: {
          tertiaryColorFg: "var(--button-tertiary-color-fg)",
          tertiaryFg: "var(--button-tertiary-fg)",
          tertiaryErrorFg: "var(--button-tertiary-error-fg)",
          secondaryColorFg: "var(--button-secondary-color-fg)",
          tertiaryColorFgHover: "var(--button-tertiary-color-fg_hover)",
          tertiaryFgHover: "var(--button-tertiary-fg_hover)",
          secondaryFg: "var(--button-secondary-fg)",
          secondaryErrorFg: "var(--button-secondary-error-fg)",
          tertiaryErrorFgHover: "var(--button-tertiary-error-fg_hover)",
          primaryFg: "var(--button-primary-fg)",
          secondaryColorFgHover: "var(--button-secondary-color-fg_hover)",
          secondaryFgHover: "var(--button-secondary-fg_hover)",
          secondaryErrorFgHover: "var(--button-secondary-error-fg_hover)",
          primaryFgHover: "var(--button-primary-fg_hover)",
          primaryBorder: "var(--button-primary-border)",
          primaryBg: "var(--button-primary-bg)",
          primaryErrorBorder: "var(--button-primary-error-border)",
          primaryErrorBg: "var(--button-primary-error-bg)",
          secondaryBorder: "var(--button-secondary-border)",
          secondaryErrorBorder: "var(--button-secondary-error-border)",
          secondaryBg: "var(--button-secondary-bg)",
          secondaryErrorBg: "var(--button-secondary-error-bg)",
          ...
          secondaryBorderHover: "var(--button-secondary-border_hover)",
          tertiaryColorBgHover: "var(--button-tertiary-color-bg_hover)",
          secondaryColorBgHover: "var(--button-secondary-color-bg_hover)",
          secondaryBgHover: "var(--button-secondary-bg_hover)",
          tertiaryBgHover: "var(--button-tertiary-bg_hover)",
